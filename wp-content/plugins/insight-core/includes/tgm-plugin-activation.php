		...
		protected function do_plugin_install() {
			...
			if ( ( isset( $_GET['tgmpa-install'] ) && 'install-plugin' === $_GET['tgmpa-install'] ) || ( isset( $_GET['tgmpa-update'] ) && 'update-plugin' === $_GET['tgmpa-update'] ) ) {
				...
				if ( $this->is_tgmpa_complete() ) {
					echo '<p>', sprintf( esc_html( $this->strings['complete'] ), '<a href="' . esc_url( self_admin_url( 'admin.php?page=insight-core' ) ) . '">' . esc_html__( 'Return to the Dashboard', 'tgmpa' ) . '</a>' ), '</p>';
					echo '<style type="text/css">#adminmenu .wp-submenu li.current { display: none !important; }</style>';
				} else {
					echo '<p><a href="', esc_url( self_admin_url( 'admin.php?page=insight-core' ) ), '" target="_parent">', esc_html( $this->strings['return'] ), '</a></p>';
				}
		...
		protected function activate_single_plugin( $file_path, $slug, $automatic = false ) {
			if ( $this->can_plugin_activate( $slug ) ) {
				...
				if ( is_wp_error( $activate ) ) {
					...
					'<p><a href="', esc_url( self_admin_url( 'admin.php?page=insight-core' ) ), '" target="_parent">', esc_html( $this->strings['return'] ), '</a></p>';
...
if ( ! class_exists( 'TGMPA_List_Table' ) ) {
	...
	class TGMPA_List_Table extends WP_List_Table {
		...
		public function no_items() {
			echo esc_html__( 'No plugins to install, update or activate.', 'tgmpa' ) . ' <a href="' . esc_url( self_admin_url( 'admin.php?page=insight-core' ) ) . '"> ' . esc_html__( 'Return to the Dashboard', 'tgmpa' ) . '</a>';
			echo '<style type="text/css">#adminmenu .wp-submenu li.current { display: none !important; }</style>';
		}
					...
					public function bulk_footer() {
						...
						if ( $this->tgmpa->is_tgmpa_complete() ) {
							...
							$update_actions['dashboard'] = sprintf(
								...
								'<a href="' . esc_url( self_admin_url( 'admin.php?page=insight-core' ) ) . '">' . esc_html__( 'Return to the Dashboard', 'tgmpa' ) . '</a>'
							);
						} else {
							$update_actions['tgmpa_page'] = '<a href="' . esc_url( self_admin_url( 'admin.php?page=insight-core' ) ) . '" target="_parent">' . esc_html( $this->tgmpa->strings['return'] ) . '</a>';
						}
