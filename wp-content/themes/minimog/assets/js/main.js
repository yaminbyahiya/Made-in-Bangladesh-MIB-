	...
	function( $ ) {
		...
		function initMobileMenu() {
			...
			$mobileMenu.on( 'click', '.mobile-nav-tabs li', function( evt ) {
				...
				$thisTabContent.attr( 'aria-expanded', true ).removeAttr( 'hidden' );
			} );
		...
		function initTopBarCountdown() {
			...
			$countdown.countdown( settings.datetime, function( event ) {
				var templateStr = '<div class="countdown-clock">'
				                  + '<div class="clock-item days"><span class="number">%D</span><span class="text">' + labels.days + '</span></div>'
				                  + '<span class="clock-divider days"></span>'
				                  + '<div class="clock-item hours"><span class="number">%H</span><span class="text">' + labels.hours + '</span></div>'
				                  + '<span class="clock-divider hours"></span>'
				                  + '<div class="clock-item minutes"><span class="number">%M</span><span class="text">' + labels.minutes + '</span></div>'
				                  + '<span class="clock-divider minutes"></span>'
				                  + '<div class="clock-item seconds"><span class="number">%S</span><span class="text">' + labels.seconds + '</span></div>'
				                  + '</div>';
		...
		function initSearchPopup() {
			...
			function openSearch( focus = '' ) {
				...
				setTimeout( function() {
					if ( 'cat' === focus ) {
						//
						/*$popupSearch.find( '.search-select' ).trigger('focus');
						$popupSearch.find( '.search-select' ).focus();*/
