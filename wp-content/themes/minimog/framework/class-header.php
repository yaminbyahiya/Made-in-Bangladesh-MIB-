	...
	class Minimog_Header {
		...
		public function print_currency_switcher() {
			...
			if ( class_exists( 'WOOMULTI_CURRENCY_Data' ) ) {
				...
				minimog_load_template( 'header/components/currency-switcher', null, $args );
			} elseif ( defined( 'WCML_VERSION' ) ) { // By WPML.
				minimog_load_template( 'header/components/wpml-currency-switcher' );
			}
		}
